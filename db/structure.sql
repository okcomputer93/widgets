...
COMMENT ON COLUMN public.widgets.widget_status_id IS 'The maker of this widget';
...
COMMENT ON INDEX public.index_widget_statuses_on_name IS 'No two widgets statuses should have the same name';
